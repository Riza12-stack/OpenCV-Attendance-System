...
window = tk.Tk()
window.title("Riza_technologies attendance system")
dialog_title = 'QUIT'
...
# Header set kiya hai
message = tk.Label(window, text="Face-Recognition-Attendance-System",
                   fg="black", width=30, height=3, font=('arial', 30, 'bold'))
message.place(x=300, y=20)

# Student Id
lbl = tk.Label(window, text="Student ID:", width=20, height=2,
               fg="white", bg="grey", font=('times', 15, ' bold '))
...
lbl3 = tk.Label(window, text="Notification: ", width=20, fg="white",
                bg="grey", height=2, font=('times', 15, ' bold underline '))
lbl3.place(x=400, y=400)

message = tk.Label(window, text="", fg="green", width=30, bg="white", borderwidth=1,
...
message2 = tk.Label(window, text="", fg="green", bg="white",
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="black", bg="green",
